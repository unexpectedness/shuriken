...
var seq__1700_1704 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1701_1705 = null;
var count__1702_1706 = (0);
var i__1703_1707 = (0);
while(true){
if((i__1703_1707 < count__1702_1706)){
var str_1708 = cljs.core._nth.call(null,chunk__1701_1705,i__1703_1707);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1708})));


var G__1709 = seq__1700_1704;
var G__1710 = chunk__1701_1705;
var G__1711 = count__1702_1706;
var G__1712 = (i__1703_1707 + (1));
seq__1700_1704 = G__1709;
chunk__1701_1705 = G__1710;
count__1702_1706 = G__1711;
i__1703_1707 = G__1712;
continue;
} else {
var temp__5804__auto___1713 = cljs.core.seq.call(null,seq__1700_1704);
if(temp__5804__auto___1713){
var seq__1700_1714__$1 = temp__5804__auto___1713;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1700_1714__$1)){
var c__5525__auto___1715 = cljs.core.chunk_first.call(null,seq__1700_1714__$1);
var G__1716 = cljs.core.chunk_rest.call(null,seq__1700_1714__$1);
var G__1717 = c__5525__auto___1715;
var G__1718 = cljs.core.count.call(null,c__5525__auto___1715);
var G__1719 = (0);
seq__1700_1704 = G__1716;
chunk__1701_1705 = G__1717;
count__1702_1706 = G__1718;
i__1703_1707 = G__1719;
continue;
} else {
var str_1720 = cljs.core.first.call(null,seq__1700_1714__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1720})));


var G__1721 = cljs.core.next.call(null,seq__1700_1714__$1);
var G__1722 = null;
var G__1723 = (0);
var G__1724 = (0);
seq__1700_1704 = G__1721;
chunk__1701_1705 = G__1722;
count__1702_1706 = G__1723;
i__1703_1707 = G__1724;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1729 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1729,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1729,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1729,"onreadystatechange",onload);

return G__1729;
})();
if((opt_sourceText == null)){
var G__1730 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1730,"src",src);

return G__1730;
} else {
var G__1731 = script__$1;
goog.dom.setTextContent(G__1731,opt_sourceText);
...
var path_1732 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_1732);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1732)].join(''));
} else {
var path_1733 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_1733);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_1733);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1733)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1734 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1735 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1735);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1734);
}})()})));
}));
