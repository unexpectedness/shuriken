...
var G__10833 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10833,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10833;
}
}));
...
args__5732__auto__.push((arguments[i__5727__auto___10839]));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10835){
var G__10836 = cljs.core.first.call(null,seq10835);
var seq10835__$1 = cljs.core.next.call(null,seq10835);
var G__10837 = cljs.core.first.call(null,seq10835__$1);
var seq10835__$2 = cljs.core.next.call(null,seq10835__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10836,G__10837,seq10835__$2);
}));
...
var map__10842 = m;
var map__10842__$1 = cljs.core.__destructure_map.call(null,map__10842);
var file = cljs.core.get.call(null,map__10842__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10842__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10842__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__10841_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10841_SHARP_));
...
var temp__5804__auto___10843 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___10843)){
var message_10844 = temp__5804__auto___10843;
cljs.core.println.call(null,message_10844);
} else {
}
...
var temp__5804__auto___10845 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___10845)){
var message_10846 = temp__5804__auto___10845;
cljs.core.println.call(null,message_10846);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__10847 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10847,"/"].join('');
} else {
return G__10847;
}
})();
...
var G__10848 = exception.stack;
var G__10848__$1 = (((G__10848 == null))?null:clojure.string.split_lines.call(null,G__10848));
var G__10848__$2 = (((G__10848__$1 == null))?null:cljs.core.get.call(null,G__10848__$1,depth));
if((G__10848__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10848__$2);
}
} else {
...
var vec__10849 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10849,(0),null);
var column = cljs.core.nth.call(null,vec__10849,(1),null);
var vec__10852 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10852,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10852,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10852,(2),null);
...
var m__$1 = (function (){var G__10855 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__10855__$1 = (((G__10855 instanceof cljs.core.Keyword))?G__10855.fqn:null);
switch (G__10855__$1) {
case "fail":
...
var G__10859 = (function (){var G__10858 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10858);
} else {
return G__10858;
}
})();
...
return cljs.core.vary_meta.call(null,G__10860,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10861){var e = e10861;
var G__10862 = e;
var G__10862__$1 = (((G__10862 instanceof cljs.core.Keyword))?G__10862.fqn:null);
switch (G__10862__$1) {
...
var vec__10864 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10864,(0),null);
var types = vec__10864;
...
return cljs.core.map.call(null,(function (p__10867){
var vec__10868 = p__10867;
var ns = cljs.core.nth.call(null,vec__10868,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10868,(1),null);
return (function (){
...
var G__10871 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__10871__$1 = (((G__10871 instanceof cljs.core.Keyword))?G__10871.fqn:null);
switch (G__10871__$1) {
case "async":
...
var seq__10872 = cljs.core.seq.call(null,vars__$1);
var chunk__10873 = null;
var count__10874 = (0);
var i__10875 = (0);
while(true){
if((i__10875 < count__10874)){
var v = cljs.core._nth.call(null,chunk__10873,i__10875);
var temp__5804__auto___10877 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___10877)){
var t_10878 = temp__5804__auto___10877;
each_fixture_fn.call(null,((function (seq__10872,chunk__10873,count__10874,i__10875,t_10878,temp__5804__auto___10877,v,each_fixture_fn,G__10871,G__10871__$1,env,once_fixtures,each_fixtures,vec__10868,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10878)));
});})(seq__10872,chunk__10873,count__10874,i__10875,t_10878,temp__5804__auto___10877,v,each_fixture_fn,G__10871,G__10871__$1,env,once_fixtures,each_fixtures,vec__10868,ns,vars__$1))
);
} else {
}


var G__10879 = seq__10872;
var G__10880 = chunk__10873;
var G__10881 = count__10874;
var G__10882 = (i__10875 + (1));
seq__10872 = G__10879;
chunk__10873 = G__10880;
count__10874 = G__10881;
i__10875 = G__10882;
continue;
} else {
...
var c__5525__auto__ = cljs.core.chunk_first.call(null,seq__10872__$1);
var G__10883 = cljs.core.chunk_rest.call(null,seq__10872__$1);
var G__10884 = c__5525__auto__;
var G__10885 = cljs.core.count.call(null,c__5525__auto__);
var G__10886 = (0);
seq__10872 = G__10883;
chunk__10873 = G__10884;
count__10874 = G__10885;
i__10875 = G__10886;
continue;
} else {
var v = cljs.core.first.call(null,seq__10872__$1);
var temp__5804__auto___10887__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___10887__$1)){
var t_10888 = temp__5804__auto___10887__$1;
each_fixture_fn.call(null,((function (seq__10872,chunk__10873,count__10874,i__10875,t_10888,temp__5804__auto___10887__$1,v,seq__10872__$1,temp__5804__auto__,each_fixture_fn,G__10871,G__10871__$1,env,once_fixtures,each_fixtures,vec__10868,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10888)));
});})(seq__10872,chunk__10873,count__10874,i__10875,t_10888,temp__5804__auto___10887__$1,v,seq__10872__$1,temp__5804__auto__,each_fixture_fn,G__10871,G__10871__$1,env,once_fixtures,each_fixtures,vec__10868,ns,vars__$1))
);
} else {
}


var G__10889 = cljs.core.next.call(null,seq__10872__$1);
var G__10890 = null;
var G__10891 = (0);
var G__10892 = (0);
seq__10872 = G__10889;
chunk__10873 = G__10890;
count__10874 = G__10891;
i__10875 = G__10892;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10871__$1)].join('')));
