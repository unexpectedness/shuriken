(ns shuriken.sequential-test
  (:require [clojure.test        :refer [deftest testing is]]
   #?(:cljs [shuriken.exception  :refer [thrown?]])
   #?(:clj  [shuriken.core       :refer :all]
      :cljs [shuriken.core       :refer [get-nth    get-nth-in
...
(deftest test-assoc-nth
  ...
  (testing "edge cases"
    (is (true? (thrown? #?(:clj IndexOutOfBoundsException :cljs #"out of bounds")
                         (assoc-nth '(1 2 3) 4 0))))
...
(deftest test-insert-at
  ...
  (testing "edge cases"
    ...
    (is (true? (thrown? #?(:clj IndexOutOfBoundsException :cljs #"out of bounds")
                        (insert-at '(1 2 3) -1 4))))
    (is (instance? #?(:clj clojure.lang.IPersistentVector :cljs PersistentVector)
                   (insert-at [1 2 3] 3 0)))
    (is (instance? #?(:clj clojure.lang.IPersistentList   :cljs List)
                   (insert-at '(1 2 3) 3 0)))
