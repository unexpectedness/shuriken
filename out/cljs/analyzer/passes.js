...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__6903_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__6903_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__6906 = ast;
if((G__6906 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__6906,passes,opts);
}
